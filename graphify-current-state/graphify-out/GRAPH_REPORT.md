...
- `fetchNextAiQuestion()` --calls--> `buildAnswersArray()`  [EXTRACTED]
  HTML-MVP-app.js → HTML-MVP-app.js  _Bridges community 10 → community 12_
- `saveLinkedPatient()` --calls--> `saveInterviewRecord()`  [EXTRACTED]
  HTML-MVP-app.js → HTML-MVP-app.js  _Bridges community 10 → community 5_
- `fuEnqueue()` --calls--> `marketingReusableRecipients()`  [EXTRACTED]
  HTML-MVP-app.js → HTML-MVP-app.js  _Bridges community 11 → community 9_
- `renderFuPreview()` --calls--> `escapeHtml()`  [EXTRACTED]
  HTML-MVP-app.js → HTML-MVP-app.js  _Bridges community 11 → community 4_
- `answerQuestion()` --calls--> `fetchNextAiQuestion()`  [EXTRACTED]
  HTML-MVP-app.js → HTML-MVP-app.js  _Bridges community 12 → community 4_
