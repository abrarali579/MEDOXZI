...
**Updated:** 2026-08-27, sessions RT2 (live-LLM interviewer harness) + RT2b (never-re-ask catalogue + prompt-contract guard) + RT2c (production UI: review Submit + interviewer no-jump)
