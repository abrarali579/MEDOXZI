...
Last verified **session AH**, on the Windows host. Evidence: VERIFICATION-LOG V-2026-08-25-AH-01 (and V-2026-08-25-AF-01, V-2026-08-25-AG-01 for the prior batches). Baseline: 100 tests / harness PASS / `node --check` on app.js, server.js, api/questions.js OK; live browser on localhost drove the adaptive intake flow with the real DeepSeek key (0 console errors).
