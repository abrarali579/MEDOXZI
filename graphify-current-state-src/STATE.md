...
**Updated:** 2026-08-24, session T (HTML MVP refinements: full name, Indonesian-first phone format with +62 default/dropdown/leading-zero strip, age+sex to LLM, pick-a-reason split with Something-else tips, clean "Analyzing Your Issue..." loading, doctor brief color grading)
